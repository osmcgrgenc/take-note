...
const Editor = (props) => {
  ...
  const handleEditorChange = (ev, value) => {
    ...
    console.log("cagrigenc1");
    setMessage(value);
  };

  // For theme of code editor
  const toggleTheme = () => {
    console.log("cagrigenc2");
      ...
      <>
        <BrowserView>
          <div className="navBar">
            <div
              className={
                theme === "light" ? "listButton-light" : "listButton-dark"
              }
            >
        ...
        <MobileView>
          <div className="mobile-notValid">
            <h1>
              Unfortunately, the code editor doesn't work on mobile. There are
              bugs that we still need to fix before we provide the mobile
              functionality.
            </h1>
  ...
  return (
    <div>
      {console.log(props)}
      {valid === true ? renderTrue() : renderFalse()}
    </div>
  );
};
